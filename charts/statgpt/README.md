...
| _backend_version | string | `"0.10.2"` | Backend version is used for both chat-backend and admin-backend image tags (must be the same for both) |
...
| _portal-frontend_version | string | `"0.6.0"` | Portal Frontend version is used for the portal-frontend image tag |
...
| admin-backend.image.tag | string | `"0.10.2"` | Image tag or version |
...
| chat-backend.image.tag | string | `"0.10.2"` | Image tag or version |
...
| portal-frontend.image.tag | string | `"0.6.0"` | Image tag or version |
