...
| _backend_version | string | `"0.6.2"` | Backend version is used for both chat-backend and admin-backend image tags (must be the same for both) |
...
| _sdmx_proxy_version | string | `"0.1.3"` | SDMX Proxy version is used for both sdmx-proxy and sdmx-proxy-config-server image tags (must be the same for both) |
...
| admin-backend.image.tag | string | `"0.6.2"` | Image tag or version |
...
| chat-backend.image.tag | string | `"0.6.2"` | Image tag or version |
...
| sdmx-proxy-config-server.image.tag | string | `"0.1.3"` | Image tag or version |
...
| sdmx-proxy.image.tag | string | `"0.1.3"` | Image tag or version |
