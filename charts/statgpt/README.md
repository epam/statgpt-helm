...
![Version: 1.13.3](https://img.shields.io/badge/Version-1.13.3-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| _backend_version | string | `"0.13.2"` | Backend version is used for both chat-backend and admin-backend image tags (must be the same for both) |
...
| admin-backend.image.tag | string | `"0.13.2"` | Image tag or version |
...
| chat-backend.image.tag | string | `"0.13.2"` | Image tag or version |
