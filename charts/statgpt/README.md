...
|-----|------|---------|-------------|
| _admin_frontend_version | string | `"0.4.1"` | Admin Frontend version is used for the admin-frontend image tag |
| _backend_version | string | `"0.11.0"` | Backend version is used for both chat-backend and admin-backend image tags (must be the same for both) |
...
| _portal-frontend_version | string | `"0.6.1"` | Portal Frontend version is used for the portal-frontend image tag |
| _postgresql_version | string | `"16.3.0-debian-12-r14"` | PostgreSQL version is used for the postgresql image tag |
| _sdmx_proxy_version | string | `"0.3.1"` | SDMX Proxy version is used for both sdmx-proxy and sdmx-proxy-config-server image tags (must be the same for both) |
...
| admin-backend.image.tag | string | `"0.11.0"` | Image tag or version |
...
| admin-frontend.image.tag | string | `"0.4.1"` | Image tag or version |
...
| chat-backend.image.tag | string | `"0.11.0"` | Image tag or version |
...
| portal-frontend.image.tag | string | `"0.6.1"` | Image tag or version |
...
| sdmx-proxy-config-server.image.tag | string | `"0.3.1"` | Image tag or version |
...
| sdmx-proxy.image.tag | string | `"0.3.1"` | Image tag or version |
